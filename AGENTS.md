...
- `/review` は明示依頼、リポジトリ固有規約の要求、または認証・認可、破壊的なデータ・スキーマ変更、秘密情報、本番操作、公開APIの破壊的変更、セキュリティ境界を扱う場合だけ使用すること。
...
- 独立レビューは原則1回、修正後の確認は変更箇所と直接影響する経路に限ること。全面再レビューは新たな重大リスクまたは影響範囲の拡大を説明できる場合に限り、反復上限と終了条件はreview skillに従うこと。
