# Cloudflare One — task-specific checks

Read only the section relevant to the current change. Product behavior and API fields must be verified against current official docs. These checks do not require gathering unrelated account data or repeating an approval already given.
