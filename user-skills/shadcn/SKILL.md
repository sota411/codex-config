---
name: shadcn
description: "Manage shadcn/ui components, registries, and presets, including projects with components.json. Use for shadcn init, --preset, component work, and related debugging."
...
When `npx shadcn@latest info --json` reports `"config": null`, the repository is not initialized for shadcn/ui.

Before initializing, explicitly plan every affected file and dependency:

- `components.json`
- Tailwind configuration and the global CSS file
- added package dependencies
- the target UI component directory such as `src/components/ui` or the project-specific equivalent

If initialization conflicts with the existing design system, build setup, Tailwind version, aliases, or component directory layout, ask the user before running init or applying a preset.
