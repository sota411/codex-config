...
- Host: `ml@wsl-rtx3080`
- ComfyUI: `/home/ml/ComfyUI`, API `http://127.0.0.1:8180`
...
- Active config: `configs/systems-delta.json`
- Remote templates: `/home/ml/kijai-lightx2v-stage1.json` and
  `/home/ml/kijai-lightx2v-stage2.json`
- Custom node: `/home/ml/ComfyUI/custom_nodes/ComfyUI-WanVideoConditioningLimit`
...
```sh
python wan_four_beat.py --config configs/systems-delta.json --profile preview dry-run
python wan_four_beat.py --config configs/systems-delta.json --profile preview run-beat --beat 1
```
