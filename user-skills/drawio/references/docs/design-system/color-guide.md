...
Step 1: Final use case? (最终用途？)
  ...
  ├── UML modeling / Astah-like notation → uml-classic
...
| **uml-classic** | `#000000` | `#000000` | `#FFFFFF` | UML class diagrams, domain models, Astah-like notation |
...
| `dependency` | Solid 1px, diamond arrow in default themes; dashed 1px, open arrow in `uml-classic` | Dependency, composition |
