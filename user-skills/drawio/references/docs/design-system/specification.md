...
meta:
  ...
  theme: tech-blue  # tech-blue | academic | academic-color | uml-classic | nature | dark | high-contrast | custom-name
...
| `uml-classic` | Astah-like classic UML notation |
...
| `umlClass` | Compartmented UML class | explicit only; aliases: `class`, `uml-class`, `uml_class` |
...
Use `type: umlClass` with `meta.theme: uml-classic` for Astah-like class boxes. The converter builds the class name, attributes, and operations into separate compartments.
...
| `dependency` in default themes | Solid 1px | Diamond | Dependencies |
| `bidirectional` | Solid 1.5px | None | Two-way |
| `association` | Solid 1px | None | UML association |
| `directedAssociation` | Solid 1px | Open arrow | UML navigable association |
| `aggregation` | Solid 1px | Hollow diamond at source | UML aggregation |
| `composition` | Solid 1px | Filled diamond at source | UML composition |
| `generalization` | Solid 1px | Hollow triangle | UML generalization |
| `realization` | Dashed 1px | Hollow triangle | UML realization |
| `dependency` in `uml-classic` | Dashed 1px | Open arrow | UML dependency |
