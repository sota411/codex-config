...
Astah-like classic UML style for class diagrams and other UML modeling diagrams.

**Best for**: UML class diagrams, domain models, implementation design reviews, teaching UML notation

**Characteristics**:

- White background, white node fill, black strokes, black text
- Square corners, no shadows, no gradients, no icons
- Compartmented `umlClass` nodes for name, attributes, and operations
- UML relationship connector types such as association, aggregation, composition, generalization, realization, and dependency
...
| Element | Color |
|---------|-------|
| UML class nodes | White fill, black stroke |
| Labels | Black (#000000) |
| Connectors | Black (#000000) |
